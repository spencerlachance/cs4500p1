...
class Serial : public Object {
    public:
        ...
        Object* deserialize() {
            ...
            char* type = buff_->get()->c_str();
            buff_ = new StrBuff(); // Clear buffer for future use.
        ...
        * */
        ...
        // /* Builds and returns an IntVector from a bytestream */
        // static IntVector* deserialize_int_vector(int i, StrBuff* buff, const char* stream) {
        //     buff = new StrBuff();
        ...
        // /* Builds and returns an BoolVector from a bytestream */
        // static BoolVector* deserialize_bool_vector(int i, StrBuff* buff, const char* stream) {
        //     buff = new StrBuff();
        //     char* x = new char[sizeof(char) + 1];
        //     x[1] = '\0';
        ...
        //         char* chr = buff->get()->c_str();
        //         buff = new StrBuff();
        //         if (strcmp(chr, "true") == 0) {
        //             bvec->append(1);
        //         } else if (strcmp(chr, "false") == 0) {
        //             bvec->append(0);
        //         }

...
void test_float_vector_serialization() {
    ...
    assert(strcmp(serial_f_arr, "{type: float_vector, floats: [1.1000000,1.1111300,1.1111150,1.1111116,1.1111115]}") == 0);
    // printf(serial_f_arr)
...
void test_string_vector_serialization() {
    ...
    assert(strcmp(serial_arr, "{type: vector, objects: [{type: string, cstr: abc},{type: string, cstr: abcd},{type: string, cstr: abcdefghi},{type: string, cstr: abcdefghij}]}") == 0);
    //printf("%s\n", serial_arr);
